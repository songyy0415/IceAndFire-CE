...
public class HippogryphSwordItem extends Item {
    public HippogryphSwordItem(ResourceKey<Item> key) {
        super(new Item.Properties().sword(IafToolMaterials.HIPPOGRYPH_SWORD_TOOL_MATERIAL.toolMaterial(), 3, -2.4F).setId(key));
    }
