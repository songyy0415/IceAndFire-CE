...
public final class IafArmorMaterials {
    ...
    public static final RegistrySupplier<ArmorMaterial> SHEEP = register("sheep", new int[]{1, 3, 2, 1}, 15, SoundEvents.ARMOR_EQUIP_LEATHER, 0, new MemorizeSupplier<>(() -> Ingredient.of(Blocks.WHITE_WOOL)));
