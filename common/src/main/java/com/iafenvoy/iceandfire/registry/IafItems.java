...
public final class IafItems {
    ...
    public static final RegistrySupplier<Item> PATTERN_FIRE = registerItem("banner_pattern_fire", key -> new Item(new Item.Properties().setId(key).stacksTo(1)));
    public static final RegistrySupplier<Item> PATTERN_ICE = registerItem("banner_pattern_ice", key -> new Item(new Item.Properties().setId(key).stacksTo(1)));
    public static final RegistrySupplier<Item> PATTERN_LIGHTNING = registerItem("banner_pattern_lightning", key -> new Item(new Item.Properties().setId(key).stacksTo(1)));
    public static final RegistrySupplier<Item> PATTERN_FIRE_HEAD = registerItem("banner_pattern_fire_head", key -> new Item(new Item.Properties().setId(key).stacksTo(1)));
    public static final RegistrySupplier<Item> PATTERN_ICE_HEAD = registerItem("banner_pattern_ice_head", key -> new Item(new Item.Properties().setId(key).stacksTo(1)));
    public static final RegistrySupplier<Item> PATTERN_LIGHTNING_HEAD = registerItem("banner_pattern_lightning_head", key -> new Item(new Item.Properties().setId(key).stacksTo(1)));
    public static final RegistrySupplier<Item> PATTERN_AMPHITHERE = registerItem("banner_pattern_amphithere", key -> new Item(new Item.Properties().setId(key).stacksTo(1)));
    public static final RegistrySupplier<Item> PATTERN_BIRD = registerItem("banner_pattern_bird", key -> new Item(new Item.Properties().setId(key).stacksTo(1)));
    public static final RegistrySupplier<Item> PATTERN_EYE = registerItem("banner_pattern_eye", key -> new Item(new Item.Properties().setId(key).stacksTo(1)));
    public static final RegistrySupplier<Item> PATTERN_FAE = registerItem("banner_pattern_fae", key -> new Item(new Item.Properties().setId(key).stacksTo(1)));
    public static final RegistrySupplier<Item> PATTERN_FEATHER = registerItem("banner_pattern_feather", key -> new Item(new Item.Properties().setId(key).stacksTo(1)));
    public static final RegistrySupplier<Item> PATTERN_GORGON = registerItem("banner_pattern_gorgon", key -> new Item(new Item.Properties().setId(key).stacksTo(1)));
    public static final RegistrySupplier<Item> PATTERN_HIPPOCAMPUS = registerItem("banner_pattern_hippocampus", key -> new Item(new Item.Properties().setId(key).stacksTo(1)));
    public static final RegistrySupplier<Item> PATTERN_HIPPOGRYPH_HEAD = registerItem("banner_pattern_hippogryph_head", key -> new Item(new Item.Properties().setId(key).stacksTo(1)));
    public static final RegistrySupplier<Item> PATTERN_MERMAID = registerItem("banner_pattern_mermaid", key -> new Item(new Item.Properties().setId(key).stacksTo(1)));
    public static final RegistrySupplier<Item> PATTERN_SEA_SERPENT = registerItem("banner_pattern_sea_serpent", key -> new Item(new Item.Properties().setId(key).stacksTo(1)));
    public static final RegistrySupplier<Item> PATTERN_TROLL = registerItem("banner_pattern_troll", key -> new Item(new Item.Properties().setId(key).stacksTo(1)));
    public static final RegistrySupplier<Item> PATTERN_WEEZER = registerItem("banner_pattern_weezer", key -> new Item(new Item.Properties().setId(key).stacksTo(1)));
    public static final RegistrySupplier<Item> PATTERN_DREAD = registerItem("banner_pattern_dread", key -> new Item(new Item.Properties().setId(key).stacksTo(1)));
