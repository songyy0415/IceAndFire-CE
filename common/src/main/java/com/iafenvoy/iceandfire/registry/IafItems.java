...
public final class IafItems {
    ...
    public static final RegistrySupplier<Item> AMBROSIA = registerItem("ambrosia", () -> new Item(new Item.Properties().stacksTo(1).usingConvertsTo(Items.BOWL).food(new FoodProperties.Builder().nutrition(5).saturationModifier(0.6F).alwaysEdible().build(), foodConsumable(new MobEffectInstance(MobEffects.STRENGTH, 3600, 2), new MobEffectInstance(MobEffects.ABSORPTION, 3600, 2), new MobEffectInstance(MobEffects.JUMP_BOOST_BOOST, 3600, 2), new MobEffectInstance(MobEffects.LUCK, 3600, 2)))));
