...
public class AmphithereModel extends DragonBaseModel<AmphithereRenderState> {
    ...
    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        if (this.animator.setAnimation(AmphithereEntity.ANIMATION_BITE)) {
        ...
        if (this.animator.setAnimation(AmphithereEntity.ANIMATION_BITE_RIDER)) {
            this.animator.startKeyframe(5);
        ...
        if (this.animator.setAnimation(AmphithereEntity.ANIMATION_WING_BLAST)) {
            this.animator.startKeyframe(5);
            this.wingBlastPose();
        ...
        if (this.animator.setAnimation(AmphithereEntity.ANIMATION_TAIL_WHIP)) {
        ...
        if (this.animator.setAnimation(AmphithereEntity.ANIMATION_SPEAK)) {
            this.animator.startKeyframe(5);
