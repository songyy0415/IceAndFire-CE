...
public class CockatriceChickModel extends DragonBaseModel<LivingEntityRenderState> {
    ...
    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4) {
        ...
        if (this.animator.setAnimation(CockatriceEntity.ANIMATION_EAT)) {
        ...
        if (this.animator.setAnimation(CockatriceEntity.ANIMATION_JUMPAT)) {
        ...
        if (this.animator.setAnimation(CockatriceEntity.ANIMATION_WATTLESHAKE)) {
        ...
        if (this.animator.setAnimation(CockatriceEntity.ANIMATION_BITE)) {
            this.animator.startKeyframe(5);
        ...
        if (this.animator.setAnimation(CockatriceEntity.ANIMATION_SPEAK)) {
            this.animator.startKeyframe(5);
