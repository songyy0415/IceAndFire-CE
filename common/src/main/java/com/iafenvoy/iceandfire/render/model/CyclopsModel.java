...
public class CyclopsModel extends DragonBaseModel<CyclopsRenderState> {
    ...
    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4) {
        ...
        if (this.animator.setAnimation(CyclopsEntity.ANIMATION_STOMP)) {
        ...
        if (this.animator.setAnimation(CyclopsEntity.ANIMATION_KICK)) {
        ...
        if (this.animator.setAnimation(CyclopsEntity.ANIMATION_EATPLAYER)) {
            this.animator.startKeyframe(10);
        ...
        if (this.animator.setAnimation(CyclopsEntity.ANIMATION_ROAR)) {
            this.animator.startKeyframe(5);
            this.rotate(this.animator, this.body, 15, 0, 0);
