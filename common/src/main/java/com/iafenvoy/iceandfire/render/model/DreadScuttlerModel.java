...
public class DreadScuttlerModel extends DragonBaseModel<LivingEntityRenderState> {
    ...
    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        if (this.animator.setAnimation(DreadScuttlerEntity.ANIMATION_BITE)) {
        ...
        if (this.animator.setAnimation(DreadScuttlerEntity.ANIMATION_SPAWN)) {
