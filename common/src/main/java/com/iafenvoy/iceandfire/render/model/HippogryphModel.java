...
public class HippogryphModel extends DragonBaseModel<HippogryphRenderState> {
    ...
    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        if (this.animator.setAnimation(HippogryphEntity.ANIMATION_SPEAK)) {
        ...
        if (this.animator.setAnimation(HippogryphEntity.ANIMATION_EAT)) {
            this.animator.startKeyframe(10);
        ...
        if (this.animator.setAnimation(HippogryphEntity.ANIMATION_BITE)) {
            this.animator.startKeyframe(5);
        ...
        if (this.animator.setAnimation(HippogryphEntity.ANIMATION_SCRATCH)) {
            this.animator.startKeyframe(5);
