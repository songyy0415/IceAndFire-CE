...
public class StymphalianBirdModel extends DragonBaseModel<StymphalianBirdRenderState> {
    ...
    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        if (this.animator.setAnimation(StymphalianBirdEntity.ANIMATION_PECK)) {
        ...
        if (this.animator.setAnimation(StymphalianBirdEntity.ANIMATION_SPEAK)) {
            this.animator.startKeyframe(5);
        ...
        if (this.animator.setAnimation(StymphalianBirdEntity.ANIMATION_SHOOT_ARROWS)) {
