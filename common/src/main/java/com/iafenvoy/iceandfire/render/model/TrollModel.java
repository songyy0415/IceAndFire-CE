...
public class TrollModel extends DragonBaseModel<TrollRenderState> {
    ...
    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        if (this.animator.setAnimation(TrollEntity.ANIMATION_SPEAK)) {
        ...
        if (this.animator.setAnimation(TrollEntity.ANIMATION_ROAR)) {
            this.animator.startKeyframe(5);
        ...
        if (this.animator.setAnimation(TrollEntity.ANIMATION_STRIKE_HORIZONTAL)) {
        ...
        if (this.animator.setAnimation(TrollEntity.ANIMATION_STRIKE_VERTICAL)) {
    ...
    public void animateStatue(TrollEntity troll) {
