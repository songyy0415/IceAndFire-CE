...
public class FireDragonScaleArmorModel extends ArmorModelBase {
    ...
    public FireDragonScaleArmorModel(boolean inner) {
    ...
    public static MeshDefinition createMesh(CubeDeformation deformation, float offset) {
        ...
        root.getChild("head").getChild("HeadFront").addOrReplaceChild("Teeth1", CubeListBuilder.create().texOffs(6, 34).addBox(-3.6F, 0.1F, -8.9F, 4, 1, 5), PartPose.offset(0.0F, -1.0F, 0.0F));
