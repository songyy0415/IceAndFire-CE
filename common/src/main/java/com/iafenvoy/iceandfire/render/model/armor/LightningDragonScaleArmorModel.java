...
public class LightningDragonScaleArmorModel extends ArmorModelBase {
    ...
    public LightningDragonScaleArmorModel(boolean inner) {
    ...
    public static MeshDefinition createMesh(CubeDeformation deformation, float offset) {
        ...
        root.getChild("head").addOrReplaceChild("HornR", CubeListBuilder.create().texOffs(48, 44).addBox(-1.0F, -0.5F, 0.0F, 2, 3, 5), PartPose.offsetAndRotation(-3.6F, -8.0F, 0.0F, 0.4363323129985824F, -0.33161255787892263F, -0.19198621771937624F));
        root.getChild("head").addOrReplaceChild("HornL", CubeListBuilder.create().texOffs(48, 44).mirror().addBox(-1.0F, -0.5F, 0.0F, 2, 3, 5), PartPose.offsetAndRotation(3.6F, -8.0F, 0.0F, 0.4363323129985824F, 0.33161255787892263F, 0.19198621771937624F));

        root.getChild("head").addOrReplaceChild("HornR3", CubeListBuilder.create().texOffs(47, 37).mirror().addBox(-0.5F, -0.8F, 0.0F, 1, 2, 4), PartPose.offsetAndRotation(-4.0F, -3.0F, 0.7F, -0.06981317007977318F, -0.4886921905584123F, -0.08726646259971647F));
        root.getChild("head").addOrReplaceChild("HornL3", CubeListBuilder.create().texOffs(47, 37).mirror().addBox(-0.5F, -0.8F, 0.0F, 1, 2, 4), PartPose.offsetAndRotation(4.0F, -3.0F, 0.7F, -0.06981317007977318F, 0.4886921905584123F, 0.08726646259971647F));
        ...
        root.getChild("head").addOrReplaceChild("HornR4", CubeListBuilder.create().texOffs(46, 36).mirror().addBox(-0.5F, -0.8F, 0.0F, 1, 2, 5), PartPose.offsetAndRotation(-4.0F, -5.1F, 0.1F, 0.12217304763960307F, -0.3141592653589793F, -0.03490658503988659F));
        root.getChild("head").addOrReplaceChild("HornL4", CubeListBuilder.create().texOffs(46, 36).mirror().addBox(-0.5F, -0.8F, 0.0F, 1, 2, 5), PartPose.offsetAndRotation(4.0F, -5.1F, -0.1F, 0.12217304763960307F, 0.3141592653589793F, 0.03490658503988659F));

        root.getChild("head").addOrReplaceChild("Teeth1", CubeListBuilder.create().texOffs(6, 34).addBox(-3.6F, 0.1F, -8.9F, 4, 1, 5), PartPose.offset(0.0F, -6.2F, 0.0F));
        ...
        root.getChild("head").getChild("HornR").addOrReplaceChild("HornR2", CubeListBuilder.create().texOffs(46, 36).mirror().addBox(-0.5F, -0.8F, 0.0F, 1, 2, 5), PartPose.offsetAndRotation(0.0F, 0.3F, 4.5F, -0.07504915783575616F, 0.5009094953223726F, 0.0F));
        root.getChild("head").getChild("HornL").addOrReplaceChild("HornL2", CubeListBuilder.create().texOffs(46, 36).mirror().addBox(-0.5F, -0.8F, 0.0F, 1, 2, 5), PartPose.offsetAndRotation(0.0F, 0.3F, 4.5F, -0.07504915783575616F, -0.5009094953223726F, 0.0F));

        root.getChild("head").getChild("HeadFront").addOrReplaceChild("Teeth2", CubeListBuilder.create().texOffs(6, 34).mirror().addBox(-0.4F, 0.1F, -8.9F, 4, 1, 5), PartPose.offset(0.0F, -1.0F, 0.0F));

        root.getChild("head").getChild("Jaw").addOrReplaceChild("Teeth3", CubeListBuilder.create().texOffs(6, 34).addBox(-3.6F, 0.1F, -8.9F, 4, 1, 5), PartPose.offset(0.0F, 3.0F, 1.4F));
        root.getChild("head").getChild("Jaw").addOrReplaceChild("Teeth4", CubeListBuilder.create().texOffs(6, 34).mirror().addBox(-0.4F, 0.1F, -8.9F, 4, 1, 5), PartPose.offset(0.0F, 3.0F, 1.4F));
